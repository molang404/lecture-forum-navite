                ...
                <Modal
                    ...
                    <Pressable
                        ...
                        {/*
                                ...
                                위에 있는 것 뿐만 아니라 아래에 있는 것들까지 그 클릭이라는 동작이 전파됨

                                Card를 바로 쓰지 않고 Pressable로 묶어서 이벤트 버블링을 막아줘야 함 (꼭 쓸 필요 없음)
                         */}
                        <Pressable
                            className={
                            ...
                            onPress={() => {}}>
                            {/*
                                    FlatList 컴포넌트도 div 태그와 매칭되는 컴포넌트 (스크롤바 있음)
