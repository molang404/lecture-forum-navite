...
interface AccordionProps {
    title: string;
    children: ReactNode;
    defaultExpanded?: boolean; // 처음 시작부터 펼쳐져 있을 건지
    className?: string; // 아코디언 전체를 감싸는 컨테니너 스타일 지정
    headerClassName?: string; // title 출력 헤어 영역 스타일 지정
        ...
        <View className={twMerge("w-full", "overflow-hidden", className)}>
            ...
            <Pressable
                ...
                className={twMerge(
                    ...
                    isExpanded && ["border-b", "border-radius"],
                    headerClassName,
                )}>
